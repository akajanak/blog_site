...
def post_list(request, tag_slug=None): 
    ...
    if tag_slug: 
        ...
        post_list = post_list.filter(tags__in=[tag]) # Pagination with 3 posts per page 
...
def post_comment(request, post_id):
    ...
    return render(request, 'blog/post/comment.html', {'post' : post, 'comments' : comment, 'form' : form})